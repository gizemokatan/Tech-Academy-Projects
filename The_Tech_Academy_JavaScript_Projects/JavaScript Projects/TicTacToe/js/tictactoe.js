...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
     //This variable retrieves the html element id that was clicked.
        ...
        // NOTE: This refers to the function below, where this named function is being implemented. 
        checkWinConditions();
        ...
        if (activePlayer === 'O') {
            // This function disables clicking from computer choice.
            disableClick();
            /* This function waits 1 second before placing the image and 
            enabling click. */
    ...
    function computersTurn() {
        ...
        while (!success) {
            ...
            /* If the random number evaluated returns true, the square
...
/* This function takes the string parameter of the path set earlier 
for placement sound ('./media/place.mp3) */
function audio(audioURL) {
    // We create a new audio object and we pass the path as a parameter.
    // NOTE: This is an instantiation of a new Auto object from the auto class.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    // NOTE: I tried renaming the function, but still not clearing the canvas.
    function clearMe() {
        // This line starts our animation loop.
        const animationLoop = requestAnimationFrame(clearMe);
    ...
    animateLineDrawing();
    /* This line waits 1 second, then clears the canvas, 
    resets the game, and allows clicking again. */
    setTimeout(function () { clearMe(); resetGame(); }, 1000);
}

// This function resets a game in a tie or a win.
function resetGame() {

...
const Calculator = {
    ...
    First_Operand: null,
    // This checks whether or not the first operand has been input.
...
function Input_Decimal(dot) {
    // This ensures accidental clicking of the decimal point doesn't cause bugs in your operation.
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null) {
        ...
        // If operator already exists, property lookup is performed for the operator in the Perform_Calculation object
...
// This updates the screen with the contents of Display_Value.
